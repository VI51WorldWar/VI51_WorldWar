...
public class Main {
    ...
    static private boolean generateMap1() {
    	...
    	try {
			objs.add(new Body(ImageIO.read(new File("img/Ants/worker.png")),new Point3d(5, 5, 0)));
			objs.add(new Body(ImageIO.read(new File("img/Ants/queen.png")),new Point3d(5, 6, 0)));
			objs.add(new Body(ImageIO.read(new File("img/Ants/warrior.png")),new Point3d(5, 7, 0)));
		} catch (IOException e) {

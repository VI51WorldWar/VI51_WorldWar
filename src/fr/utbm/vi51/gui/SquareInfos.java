...
public class SquareInfos extends JPanel {
    ...
    private Square rSquareReference;
    private Point3D squarePosition;

    private JButton buttonAddFood;
    private JComboBox<LandType> comLandType;
    private List<PheromoneBar> listBars;
    ...
    public void setSquare(Square squareReference, Point3d squarePosition) {
        ...
        if (squareReference == null) {
            ...
            this.comLandType.setSelectedItem(this.rSquareReference
                    .getLandType());
        }
        for (PheromoneBar bar : this.listBars) {
            this.remove(bar);
    ...
    private void drawSquareInfos(Graphics g, Point drawPosition) {
        ...
        // Square location
        g.drawString("Coord : " + this.squarePosition.toString(), drawPos.x,
                drawPos.y);
    ...
    private void initAddFoodButton() {
        ...
        ActionListener action = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Environment.getInstance().addWorldObject(
                        new Food(new Point3D(SquareInfos.this.squarePosition)));
            }
        };
    ...
    void changeLandType() {
        ...
        this.rSquareReference.setLandType((LandType) this.comLandType
                .getSelectedItem());
    }
}

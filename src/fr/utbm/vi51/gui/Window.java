...
public class Window extends JFrame {
    ...
    private SquareInfos sqInfos;

    // Tracker
    private InsectTracker insectTracker;
    ...
    public void paintRoad(Graphics g, int tileWidth, int tileHeight,
        ...
        if (this.insectTracker != null) {
            this.insectTracker
                    .paintRoad(g, tileWidth, tileHeight, levelPainted);
        }
    }
    ...
    private void addTracker() {
        GridBagConstraints c = new GridBagConstraints();
        this.insectTracker = new InsectTracker(
                /*this,*/this.view.getViewReference());
        c.fill = GridBagConstraints.BOTH;
        c.gridx = 1;
        c.gridy = 4;
        c.gridheight = 1;
